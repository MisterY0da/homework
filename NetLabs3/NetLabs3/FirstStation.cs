...
namespace NetsLab3
{
    public class FirstStation
    {
        ...
        public FirstStation(ref Semaphore firstStToSecondBuf, ref Semaphore firstBufToFirstSt, ref Semaphore secondStToFirstSt, 
            ref Semaphore firstStToSecondSt, ref Semaphore connectionSem, ref Semaphore disConnectionSem)
        {
        ...
        public void SendFramesToSecondBuf(object obj)
        {
            ...
            ConsoleHelper.WriteToConsole("станция 1", "файл передан станции 2 по пути: ...NetLabs3\\NetLabs3\\bin\\Debug\\netcoreapp3.1\\St2_File.txt");
        ...
        {
            string str = "some good data from st. #1 file!";
        ...
        private static void WriteDataToStFile(string data, bool append)
        {
            ...
            string filePath = curDir + "\\St1_File.txt";
